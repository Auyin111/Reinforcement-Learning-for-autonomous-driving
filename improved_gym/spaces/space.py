...
class Space(Generic[T_cov]):
    ...
    * They provide a method to sample random elements. This is especially useful for exploration and debugging.
    ...
    Warning:
        ...
        :meth:`Space.sample()` method), and batching functions (in :class:`improved_gym.vector.VectorEnv`), are
        only well-defined for instances of spaces provided in improved_gym by default.
