...
class Dict(Space[TypingDict[str, Space]], Mapping):
    ...
    Example usage:
        ...
        >>> from improved_gym.spaces import Dict, Discrete
    ...
    Example usage [nested]::
        ...
        >>> from improved_gym.spaces import Box, Dict, Discrete, MultiBinary, MultiDiscrete
        >>> Dict(
        ...     {
    ...
    def __init__(
        ...
        **spaces_kwargs: Space,
        ...
        Example::
            ...
            >>> from improved_gym.spaces import Box, Discrete
    ...
    def __setitem__(self, key: str, value: Space):
        ...
        assert isinstance(
            value, Space
        ), f"Trying to set {key} to Dict space with value that is not a improved_gym space, actual type: {type(value)}"
