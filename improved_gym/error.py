"""Set of Error classes for improved_gym."""
import warnings
...
class APIError(Error):
    """Deprecated, to be removed at improved_gym 1.0."""
    ...
    def __init__(
        ...
        warnings.warn("APIError is deprecated and will be removed at improved_gym 1.0")
...
class CustomSpaceError(Exception):
    """The space is a custom improved_gym.Space instance, and is not supported by `AsyncVectorEnv` with `shared_memory=True`."""
