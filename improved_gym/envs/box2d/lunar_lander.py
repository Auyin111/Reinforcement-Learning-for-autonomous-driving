...
import improved_gym
from improved_gym import error, spaces
from improved_gym.error import DependencyNotInstalled
from improved_gym.utils import EzPickle, colorize
from improved_gym.utils.step_api_compatibility import step_api_compatibility
...
try:
    ...
    raise DependencyNotInstalled("box2d is not installed, run `pip install improved_gym[box2d]`")
...
class LunarLander(improved_gym.Env, EzPickle):
    """
    ### Description
    ...
    ```
    python improved_gym/envs/box2d/lunar_lander.py
    ```
    ...
    def render(self):
        if self.render_mode is None:
            improved_gym.logger.warn(
                "You are calling render method without specifying any render mode. "
                "You can specify the render_mode at initialization, "
                f'e.g. improved_gym("{self.spec.id}", render_mode="rgb_array")'
            )
            return
        ...
        try:
            ...
            raise DependencyNotInstalled(
                "pygame is not installed, run `pip install improved_gym[box2d]`"
            )
...
class LunarLanderContinuous:
    def __init__(self):
        raise error.Error(
            ...
            "To use this environment, instead create it by specifying the continuous keyword in improved_gym.make, i.e.\n"
            'improved_gym.make("LunarLander-v2", continuous=True)'
        )
