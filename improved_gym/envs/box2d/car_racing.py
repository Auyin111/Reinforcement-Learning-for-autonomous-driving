...
from improved_gym.envs.box2d.car_dynamics import Car
...
class CarRacing(improved_gym.Env, EzPickle):
    """
    ### Description
    ...
    ```
    python improved_gym/envs/box2d/car_racing.py
    ```
    ...
    Example usage:
    ```py
        env = improved_gym.make("CarRacing-v1", domain_randomize=True)
