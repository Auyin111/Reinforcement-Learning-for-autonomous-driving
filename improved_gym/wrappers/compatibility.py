...
from improved_gym.utils.step_api_compatibility import convert_to_terminated_truncated_step_api
...
class LegacyEnv(Protocol):
    ...
    observation_space: improved_gym.Space
    action_space: improved_gym.Space
...
class EnvCompatibility(improved_gym.Env):
