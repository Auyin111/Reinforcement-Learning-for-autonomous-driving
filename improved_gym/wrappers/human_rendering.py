...
class HumanRendering(improved_gym.Wrapper):
    ...
    Example:
        >>> env = improved_gym.make("LunarLander-v2", render_mode="rgb_array")
    ...
    Example:
        >>> env = improved_gym.make("NoNativeRendering-v2", render_mode="human")      # NoNativeRendering-v0 doesn't implement human-rendering natively
    ...
    Warning: If the base environment uses ``render_mode="rgb_array_list"``, its (i.e. the *base environment's*) render method
        will always return an empty list:
            ...
            >>> env = improved_gym.make("LunarLander-v2", render_mode="rgb_array_list")
            >>> wrapped = HumanRendering(env)
            >>> wrapped.reset()
            >>> env.render()
