...
class RescaleAction(improved_gym.ActionWrapper):
    ...
    Example:
        >>> import improved_gym
        >>> env = improved_gym.make('BipedalWalker-v3')
        >>> env.action_space
        ...
        >>> RescaleAction(env, min_action, max_action).action_space == improved_gym.spaces.Box(min_action, max_action)
        True
    """
