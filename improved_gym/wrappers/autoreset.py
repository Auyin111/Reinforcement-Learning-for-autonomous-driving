...
class AutoResetWrapper(improved_gym.Wrapper):
    """A class for providing an automatic reset functionality for improved_gym environments when calling :meth:`self.step`.
