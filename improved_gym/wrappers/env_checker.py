...
import improved_gym
from improved_gym.core import ActType
...
class PassiveEnvChecker(improved_gym.Wrapper):
    """A passive environment checker wrapper that surrounds the step, reset and render functions to check they follow the improved_gym API."""
