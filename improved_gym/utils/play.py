...
import improved_gym.error
from improved_gym import Env, logger
from improved_gym.core import ActType, ObsType
from improved_gym.error import DependencyNotInstalled
from improved_gym.logger import deprecation
...
try:
    ...
    raise improved_gym.error.DependencyNotInstalled(
        "Pygame is not installed, run `pip install improved_gym[classic_control]`"
    )
...
try:
    ...
    logger.warn("Matplotlib is not installed, run `pip install improved_gym[other]`")
...
def play(
    ...
    Example::
        ...
        >>> import improved_gym
        >>> from improved_gym.utils.play import play
        >>> play(improved_gym.make("CarRacing-v1", render_mode="rgb_array"), keys_to_action={
        ...                                                "w": np.array([0, 0.7, 0]),
        ...                                                "a": np.array([-1, 0, 0]),
        ...                                                "s": np.array([0, 0, 1]),
        ...                                                "d": np.array([1, 0, 0]),
    ...
    for last 150 steps.
        ...
        >>> play(improved_gym.make("ALE/AirRaid-v5"), callback=plotter.callback)
    ...
    def __init__(
        ...
        if plt is None:
            raise DependencyNotInstalled(
                "matplotlib is not installed, run `pip install improved_gym[other]`"
            )
