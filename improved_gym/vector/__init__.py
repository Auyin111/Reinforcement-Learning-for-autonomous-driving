...
import improved_gym
from improved_gym.vector.async_vector_env import AsyncVectorEnv
from improved_gym.vector.sync_vector_env import SyncVectorEnv
from improved_gym.vector.vector_env import VectorEnv, VectorEnvWrapper
...
def make(
    ...
    **kwargs,
    ...
    Example::
        ...
        >>> import improved_gym
        >>> env = improved_gym.vector.make('CartPole-v1', num_envs=3)
        >>> env.reset()
    ...
    def create_env(env_num: int):
        ...
        def _make_env():
            env = improved_gym.envs.registration.make(
                id,
