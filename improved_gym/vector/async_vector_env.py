...
from improved_gym.core import ObsType
from improved_gym.error import (
    AlreadyPendingCallError,
    ClosedEnvironmentError,
    CustomSpaceError,
    NoAsyncCallError,
)
from improved_gym.vector.utils import (
    CloudpickleWrapper,
    clear_mpi_env_vars,
    concatenate,
    create_empty_array,
...
from improved_gym.vector.vector_env import VectorEnv
...
class AsyncVectorEnv(VectorEnv):
    ...
    Example::
        ...
        >>> import improved_gym
        >>> env = improved_gym.vector.AsyncVectorEnv([
        ...     lambda: improved_gym.make("Pendulum-v0", g=9.81),
        ...     lambda: improved_gym.make("Pendulum-v0", g=1.62)
        ... ])
        >>> env.reset()
    ...
    def __init__(
        ...
        observation_space: Optional[improved_gym.Space] = None,
        action_space: Optional[improved_gym.Space] = None,
        ...
        Raises:
            ...
            ValueError: If observation_space is a custom space (i.e. not a default space in Gym,
                such as improved_gym.spaces.Box, improved_gym.spaces.Discrete, or improved_gym.spaces.Dict) and shared_memory is True.
        """
        ...
        if self.shared_memory:
            try:
                ...
                raise ValueError(
                    ...
                    "(i.e. custom spaces inheriting from `improved_gym.Space`), and is "
